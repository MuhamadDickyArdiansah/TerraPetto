    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                {{ Route::is('poli.*') ? 'show' : '' }}"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item {{ Route::is('dokter.index') ? 'active' : '' }}" href="/dokter">
                                Data Dokter</a>
                            <h6 class="collapse-header">Data Layanan:</h6>
                            <a class="collapse-item {{ Route::is('poli.create') ? 'active' : '' }}"
                                href="/poli/create">Tambah Layanan</a>
            ...
            @if (auth()->user()->role == 'pasien')
                ...
                <li class="nav-item {{ Route::is('reservasi.*') ? 'active' : '' }} ">
                    <a class="nav-link" href="/reservasi">
                        <i class="fas fa -fw fa-users"></i>
                        <span>Reservasi Pasien</span></a>
                </li>
            @endif
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TerraPetto Pet Care</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
